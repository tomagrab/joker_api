...
public class StonlyAiController(IStonlyAiService stonlyAiService) : ControllerBase
{
    ...
    [ProducesResponseType(typeof(CommonApiResponseModel<StonlyAiAnswerResponseEntity>), StatusCodes.Status200OK)]
    ...
    [Produces("application/json")]
    [ProducesResponseType(typeof(CommonApiResponseModel<StonlyAiAnswerResultStatusEntity?>), StatusCodes.Status200OK)]
    ...
    [HttpPost("recommend-guides")]
    [Produces("application/json")]
    [ProducesResponseType(typeof(CommonApiResponseModel<StonlyAiGuideRecommendationResultEntity>), StatusCodes.Status200OK)]
    public async Task<ActionResult<CommonApiResponseModel<StonlyAiGuideRecommendationResultEntity>>> StonlyAiRecommendGuidesAsync(StonlyAiGuideRecommendationRequestEntity request, CancellationToken cancellationToken = default)
    {
        var recommendationResponse = await _stonlyAiService.StonlyAiRecommendGuidesAsync(request, cancellationToken);
